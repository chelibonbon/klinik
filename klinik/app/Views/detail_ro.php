	...
	<section class="section">
		<div class="row">
			<div class="col-lg-12">
				...
				<div class="card">
					<div class="card-body">
						<h5 class="card-title">detail resep obat</h5>
						<form action="<?= base_url('home/simpan_ro') ?>" method="POST">
							<table> 
								<tr>
									<td>id obat</td>
									<td><input type="number" class="form-control" name="idobat" value="<?= $takdirestui->id_obat ?>"></td>
								</tr>
								<tr>
									<td>aturan pakai</td>
								...
								<tr>
									<td></td>
									<td><input type="hidden" name="id" value="<?= $takdirestui->id_ro ?>">
									</td>
								</tr>
							</table>
						</form>
